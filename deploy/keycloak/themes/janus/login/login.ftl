...
<body class="janus-login">
  <header class="login-header" aria-label="Janus">
    <div class="brand">Janus</div>
    <div class="eyebrow">${msg("janusAuthEyebrow")}</div>
  </header>
    ...
    <section class="login-card" aria-labelledby="login-title">
      <div class="product-icon" aria-hidden="true">
        <svg viewBox="0 0 48 48" focusable="false">
          <path d="M10 8h18a3 3 0 0 1 3 3v29H10V8Z"/>
          <path d="M31 18h8a3 3 0 0 1 3 3v19H31V18Z"/>
          <path d="M17 16h4M17 24h4M17 32h4M26 16h4M26 24h4M26 32h4M36 26h2M36 32h2"/>
        </svg>
      </div>

      <h1 id="login-title">${msg("janusLoginTitle")}</h1>
