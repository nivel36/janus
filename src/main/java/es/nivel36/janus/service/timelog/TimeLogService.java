...
public class TimeLogService {
	 ...
	 * @throws NullPointerException  if the employee or exitTime is null
	 * @throws IllegalStateException if there is no TimeLog for the employee
	 */
	 ...
	 * @return the {@link TimeLog} with the specified id, or null if not found
	...
	public void setTimeLogService(final TimeLogRepository timeLogRepository) {
		this.timeLogRepository = Objects.requireNonNull(timeLogRepository, "TimeLogRepository can not be null");
	}
}
