...
/**
 * Exception thrown when attempting to finalize a
 * {@code ClockOutWithoutClockInEvent} record that has already been finalized.
 */
public class EventAlreadyFinalizedException extends RuntimeException {
	 ...
	 */
	public EventAlreadyFinalizedException(final String message) {
		super(message);
	}
	 ...
	 *              permitted.
	 */
	public EventAlreadyFinalizedException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public EventAlreadyFinalizedException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public EventAlreadyFinalizedException(final String message, final Throwable cause, final boolean enableSuppression,
