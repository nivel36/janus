...
CREATE TABLE APP_USER (
  ...
  TIME_FORMAT   VARCHAR2(16)  NOT NULL,
  CONSTRAINT UK_APP_USER_ACCOUNT UNIQUE (ACCOUNT_ID),
  CONSTRAINT FK_APP_USER_ACCOUNT
...
CREATE TABLE DAY_OF_WEEK_TIME_RANGE (
  ...
  EFFECTIVE_WORK_HOURS VARCHAR2(16) NOT NULL,
...
CREATE TABLE WORK_SHIFT (
  ...
  DATE               DATE   NOT NULL,
  TOTAL_PAUSE_TIME   VARCHAR2(16) NOT NULL,
  TOTAL_WORK_TIME    VARCHAR2(16) NOT NULL,
