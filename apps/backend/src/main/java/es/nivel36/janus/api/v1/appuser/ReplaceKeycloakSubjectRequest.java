 ...
 *
 * @param keycloakSubject opaque external identity subject; must not be blank and
 *                        must not exceed 255 characters
 */
public record ReplaceKeycloakSubjectRequest(
		@NotBlank(message = "keycloakSubject must not be blank")
		@Size(max = 255, message = "keycloakSubject must not exceed 255 characters") String keycloakSubject) {
}
