...
public class Worksite implements Serializable {
    ...
    /**
     * Optional textual description of the worksite.
     *
     * <p>
     * This field may be {@code null} and is intended for additional
    ...
    /**
     * Physical or mailing address of the worksite.
     *
     * <p>
     * This field may be {@code null} and is used for location-related
    ...
    public Worksite(
        ...
        this.code = Strings.requireNonBlank(
            code,
            "code can't be null or blank"
        );
        this.name = Strings.requireNonBlank(
            name,
    ...
    /**
     * Returns the optional description of the worksite.
     *
     * @return the description, or {@code null} if not defined
     */
    ...
    /**
     * Updates the description of the worksite.
     *
    ...
    /**
     * Returns the address of the worksite.
     *
     * @return the address, or {@code null} if not defined
     */
    ...
    /**
     * Updates the address of the worksite.
     *
     * @param address the new address; may be {@code null}
     */
    ...
    public void updateScope(final WorksiteScope scope) {
        ...
        if (
            this.scope == WorksiteScope.GLOBAL ||
            scope == WorksiteScope.ASSIGNED
        ) {
            throw new IllegalArgumentException(
                "Invalid scope transition from " + this.scope + " to " + scope
            );
        }
        this.scope = scope;
    }
    ...
    /**
     * Indicates whether this worksite has been logically deleted.
     *
     * @return {@code true} if the worksite is marked as deleted;
    ...
    void setTimeLogs(final Set<TimeLog> timeLogs) {
        this.timeLogs = Objects.requireNonNull(
            timeLogs,
            "timeLogs can't be null"
        );
    }
