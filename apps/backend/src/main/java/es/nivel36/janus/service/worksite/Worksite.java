 ...
 * to every employee or {@link WorksiteScope#ASSIGNED assigned}, which requires
 * an explicit employee assignment.
 * </p>
 *
 * <p>
...
public class Worksite implements Serializable {
	 ...
	 *
	 * <p>
	 * This field may be {@code null} and is intended for additional human-readable
	 * details.
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * This field may be {@code null} and is used for location-related information
	 * when applicable.
	 * </p>
	 */
	...
	/**
	 * Employees explicitly associated with this worksite through employee-worksite
	 * link table.
	 *
	 * <p>
