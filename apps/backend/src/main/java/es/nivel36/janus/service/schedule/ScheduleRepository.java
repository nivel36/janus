...
interface ScheduleRepository extends JpaRepository<Schedule, Long> {
	 ...
	 *
	 * <p>
	 * The associated {@code rules} and their {@code dayOfWeekRanges} are eagerly
	 * loaded using an {@link EntityGraph}.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * The search is performed against the {@code name} and {@code code} fields
	 * using a case-insensitive {@code LIKE} comparison.
	 * </p>
	 *
	 * <p>
