 ...
 *
 * <p>
 * An {@code AppUser} is identified by {@code sub}. The accepted {@code iss} is
 * configured on the Spring resource server. Email remains a contact attribute
 * and its use by Employee authorization is transitional until AppUser and
 * Employee have an explicit relationship.
 * </p>
 */
@Component
