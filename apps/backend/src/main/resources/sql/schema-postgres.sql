...
CREATE TABLE DAY_OF_WEEK_TIME_RANGE (
  ...
  EFFECTIVE_WORK_HOURS BIGINT NOT NULL,
...
CREATE INDEX IDX_APP_USER_EMPLOYEE ON APP_USER(EMPLOYEE_ID);
...
CREATE INDEX IDX_TIMELOG_EMPLOYEE_OPEN_ENTRY ON TIME_LOG(EMPLOYEE_ID, EXIT_TIME, ENTRY_TIME DESC);
CREATE INDEX IDX_TIMELOG_EMPLOYEE_ORPHAN_ENTRY ON TIME_LOG(EMPLOYEE_ID, DELETED, WORKSHIFT_ID, ENTRY_TIME DESC);
