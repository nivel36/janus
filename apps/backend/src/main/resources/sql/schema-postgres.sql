...
CREATE TABLE WORKSITE (
  ...
  CONSTRAINT CK_WORKSITE_SCOPE_OWNER
    CHECK (
      ((SCOPE = 'GLOBAL' OR SCOPE = 'ASSIGNED') AND OWNER_EMPLOYEE_ID IS NULL)
...
CREATE INDEX IDX_WORKSITE_OWNER_EMPLOYEE ON WORKSITE(OWNER_EMPLOYEE_ID);
...
ALTER TABLE WORKSITE
  ADD CONSTRAINT FK_WORKSITE_OWNER_EMPLOYEE
  FOREIGN KEY (OWNER_EMPLOYEE_ID) REFERENCES EMPLOYEE(ID) ON DELETE RESTRICT;
