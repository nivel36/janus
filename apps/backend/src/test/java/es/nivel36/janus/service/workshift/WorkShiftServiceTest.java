...
class WorkShiftServiceTest {
    ...
    public static Stream<Arguments> provideTimeLogArguments() {
        ...
        worksite.assignEmployee(employee);
            ...
            Arguments.of(
                ...
                Arrays.asList(
                    ...
                    new TimeLog(
                        employee,
                        worksite,
                        halfDayWithCrunch[10],
                        halfDayWithCrunch[11]
                    ) //
                ), //
                Duration.ofHours(11), //
                Duration.ofHours(3), //
    ...
    private static Instant buildInstant(
    ...
    void testFindWorkShiftForWorkingDay(
        ...
        final Instant fromInstant = date
            .atStartOfDay(z)
            .toInstant()
            .minus(1, ChronoUnit.DAYS);
        final Instant toInstant = date
            .atStartOfDay(z)
            .toInstant()
        ...
        when(
            this.timeLogService.searchTimeLogsByEmployeeEmailAndEntryTimeInRange(
        ...
        when(
            this.scheduleService.findTimeRangeForEmployeeByDate(
                this.employee.getEmail(),
                date
            )
        ...
        // Act
        final WorkShift result = this.workShiftService.findWorkShift(
            this.employee,
            this.worksite,
            date
        );
