...
CREATE TABLE EMPLOYEE (
  ...
  CONSTRAINT CK_EMPLOYEE_EMAIL_CANONICAL CHECK (EMAIL = LOWER(TRIM(EMAIL))),
...
CREATE UNIQUE INDEX UK_EMPLOYEE_PRINCIPAL_ACTIVE_SELF_EMPLOYEE ON EMPLOYEE_PRINCIPAL(EMPLOYEE_ID);
CREATE UNIQUE INDEX UK_EMPLOYEE_PRINCIPAL_ACTIVE_SELF_PRINCIPAL ON EMPLOYEE_PRINCIPAL(SECURITY_PRINCIPAL_ID);
